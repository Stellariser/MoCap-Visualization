...
public class Simulator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scene3.onClick.AddListener(() => { ChooseSceneUI.SetActive(false); AreyourRedyUI.SetActive(true); applyAverageFilter = false; isanimation = true; isTutorial = false; }); // fabricated data
